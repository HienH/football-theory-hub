      ...
      <div className="mt-10 flex flex-col gap-6">
        {articles.map((article) => (
          <Link
            ...
            className="group flex flex-col md:flex-row rounded-xl border border-border bg-secondary/30 overflow-hidden transition-all hover:border-gold/40 hover:shadow-lg"
          >
